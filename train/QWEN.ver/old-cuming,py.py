...
data_name = "large2_dataset.jsonl"

# 假设每条 JSON 的字段名是 "text"
raw_datasets = load_dataset("../../json", data_files={"train": data_name})
...
peft_config = LoraConfig(
    r=8, lora_alpha=128, target_modules=["q_proj","v_proj","k_proj","o_proj","gate_proj","up_proj","down_proj"], lora_dropout=0.0, bias="none", task_type="CAUSAL_LM"
)
